...
export function CinematicHero({ 
  brandName = "A2Z",
  tagline1 = "Neutralisez vos goulots,",
  tagline2 = "sécurisez vos opérations.",
  cardHeading = "L'IA au service de votre étude.",
  cardDescription = <><span className="text-white font-semibold">A2Z Consulting</span> déploie des flux sur mesure pour désengorger vos équipes juridiques. Une infrastructure invisible, hébergée en Suisse, dans le strict respect de la nLPD.</>,
  metricValue = 100,
  metricLabel = "% Conformité nLPD",
  ctaHeading = "Passez à la vitesse supérieure.",
  ctaDescription = "Réservez votre audit de faisabilité technique. Échange de 15 minutes, strictement confidentiel.",
  className, 
  ...props 
}: CinematicHeroProps) {
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="#" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group">
            ...
            <div className="text-left">
              ...
              <div className="text-xl font-bold leading-none tracking-tight">Cadrage 15 min</div>
            </div>
          </a>
          <a href="#" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group">
            ...
            <div className="text-left">
              ...
              <div className="text-xl font-bold leading-none tracking-tight">Notre Approche</div>
            </div>
          </a>
        </div>
      </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-neutral-400 uppercase tracking-widest font-bold mb-1">Système</span>
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Connecté</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">A2Z</div>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500/20 to-indigo-600/5 flex items-center justify-center mr-3 border border-indigo-400/20 shadow-inner">
                            <Lock className="w-4 h-4 text-indigo-400 drop-shadow-md" />
                          </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Data Suisse</p>
                    <p className="text-red-200/50 text-[10px] lg:text-xs font-medium">Hébergement local</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-indigo-500/20 to-indigo-900/10 flex items-center justify-center border border-indigo-400/30 shadow-inner">
                    <ShieldCheck className="w-4 h-4 lg:w-5 lg:h-5 text-indigo-400" />
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Conformité nLPD</p>
                    <p className="text-indigo-200/50 text-[10px] lg:text-xs font-medium">Secret professionnel</p>
                  </div>
                </div>
